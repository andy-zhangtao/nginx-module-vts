...
)
{
    ...
    if (vtsn != NULL)
    {
        buf = ngx_sprintf(buf, NGX_HTTP_VHOST_TRAFFIC_STATUS_JSON_FMT_UPSTREAM,
                          ...
                          vtsn->stat_499_counter, vtsn->stat_500_counter,
                          vtsn->stat_502_counter, vtsn->stat_504_counter,
                          vtsn->stat_5xx_counter,
                          vtsn->stat_request_time_counter,
                          ngx_http_vhost_traffic_status_node_time_queue_average(
                              &vtsn->stat_request_times, vtscf->average_method,
                          ...
                          vtsn->stat_4xx_counter_oc, vtsn->stat_499_counter_oc,
                          vtsn->stat_500_counter_oc, vtsn->stat_502_counter_oc,
                          vtsn->stat_504_counter_oc, vtsn->stat_5xx_counter_oc,
